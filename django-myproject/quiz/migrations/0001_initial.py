...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('question_type', models.CharField(choices=[('MCQ', 'Multiple Choice Question'), ('TF', 'True/False'), ('MA', 'Multiple Answer'), ('MATCH', 'Matching'), ('CLOZE', 'Cloze (Fill in the Blanks)'), ('OPEN', 'Open-ended')], default='MCQ', max_length=5)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('code', models.CharField(max_length=6)),
                ('expiry', models.DateTimeField()),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='quiz.customuser')),
            ],
        ),
        migrations.CreateModel(
            name='Answer',
